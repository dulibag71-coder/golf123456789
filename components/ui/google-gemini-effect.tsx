    ...
    return (
        <div className={cn("sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-black", className)}>
            <div className="z-50 relative flex flex-col items-center">
                ...
                <p className="text-base md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto px-4">
                    {description ||
                        `Scroll down to witness the power of AI-driven golf coaching.`}
                </p>
                <div className="mt-8 flex gap-4">
                    <Link href="/auth">
                        <button className="px-8 py-3 rounded-full bg-white text-black font-bold hover:bg-neutral-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                            Get Started
                        </button>
                    </Link>
                    <Link href="/analysis">
                        <button className="px-8 py-3 rounded-full border border-white/20 text-white font-medium hover:bg-white/10 transition-colors backdrop-blur-sm">
                            Try Demo
                        </button>
                    </Link>
                </div>
